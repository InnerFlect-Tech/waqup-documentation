...
graph TB
    ...
    subgraph "Marketplace Services"
        ...
        RewardSvc[Reward Service<br/>Token Distribution, Value Tracking<br/>REST API<br/>see [Value & Growth Economy](./WAQUP_VALUE_AND_GROWTH_ECONOMY.md)]
    end
...
**Note**: see [Content Types & Taxonomy](#content-types--taxonomy) document for detailed schema and type definitions.
...
**Note**: For comprehensive security architecture details, see [Architecture Overview](#architecture-overview) document. For ethical data handling principles, see [AI Voice & Ethics](./WAQUP_AI_VOICE_AND_ETHICS.md) document.
...
**Note**: For detailed data flow security patterns, see [Data Flow](#data-flow) document. For ethical privacy principles, see [AI Voice & Ethics](./WAQUP_AI_VOICE_AND_ETHICS.md) document.
