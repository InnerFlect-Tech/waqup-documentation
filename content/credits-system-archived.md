...
> This document is kept for historical reference. The complete, up-to-date content has been merged into the **[Value & Growth Economy](./waqup_value_and_growth_economy.html#credits-system)** document.

**Domain**: HOW credits manage AI resource consumption and enable intentional creation (resource management, not gamification)

---

**Related SSOT Documents**:
- Content Types & Taxonomy: Three content types and their credit costs
- Value & Growth Economy: Overall economic model and value circulation
- Features & Workflows: How credits integrate with content creation
- Architecture Overview: Credit Management Service implementation
- User Journey: Credit purchase and consumption experience
