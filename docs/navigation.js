...
(function() {
    function initSidebar() {
        ...
        // Check if sidebar is already populated (avoid double initialization)
        if (sidebar.innerHTML.trim() && !sidebar.innerHTML.includes('Sidebar generated by navigation.js')) {
